<!-- cms:task type="LiveViewSpec" component="MetricFlowWeb.DashboardLive.Editor" -->
...
Component Description: Create/edit dashboards, arrange visualizations.
Type: liveview
...
Write the document to .code_my_spec/spec/metric_flow_web/dashboard_live/editor.spec.md.
