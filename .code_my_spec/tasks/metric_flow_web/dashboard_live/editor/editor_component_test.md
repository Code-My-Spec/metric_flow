<!-- cms:task type="ComponentTest" component="MetricFlowWeb.DashboardLive.Editor" -->
...
Component Design File: .code_my_spec/spec/metric_flow_web/dashboard_live/editor.spec.md
...
Write the test file to test/metric_flow_web/live/dashboard_live/editor_test.exs.
