...
Component Design File: .code_my_spec/spec/metric_flow_web/correlation_live/goals.spec.md
...
Write the test file to test/metric_flow_web/live/correlation_live/goals_test.exs.
