...
Component Description: Configure goal metrics. Allows an authenticated user to select which metric serves as the goal metric against which all other metrics are correlated by the correlation engine.
Type: liveview

Spec File: .code_my_spec/spec/metric_flow_web/correlation_live/goals.spec.md
Test File: test/metric_flow_web/live/correlation_live/goals_test.exs
...
Write the implementation to lib/metric_flow_web/live/correlation_live/goals.ex
