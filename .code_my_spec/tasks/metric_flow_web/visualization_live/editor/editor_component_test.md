...
Component Design File: .code_my_spec/spec/metric_flow_web/visualization_live/editor.spec.md
...
Write the test file to test/metric_flow_web/live/visualization_live/editor_test.exs.
