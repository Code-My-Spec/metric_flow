...
Component Description: List and view saved reports. Displays user-created and system-generated reports including review metric summaries, rolling averages, and cross-platform performance snapshots. Reports aggregate data from the Metrics context into presentable, shareable formats distinct from real-time dashboards.
Type: liveview

Spec File: .code_my_spec/spec/metric_flow_web/report_live/index.spec.md
Test File: test/metric_flow_web/live/report_live/index_test.exs
...
Write the implementation to lib/metric_flow_web/live/report_live/index.ex
