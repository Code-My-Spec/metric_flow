...
Component Design File: .code_my_spec/spec/metric_flow_web/ai_live/report_generator.spec.md
...
Write the test file to test/metric_flow_web/live/ai_live/report_generator_test.exs.
