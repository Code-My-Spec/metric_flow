<!-- cms:task type="LiveViewSpec" component="MetricFlowWeb.AiLive.Insights" -->
...
Component Description: AI insights panel displaying AI-generated recommendations from correlation analysis, with suggestion type filtering and per-insight helpful/not-helpful feedback.
Type: liveview

Existing Implementation: lib/metric_flow_web/live/ai_live/insights.ex
Existing tests: test/metric_flow_web/live/ai_live/insights_test.exs
...
Write the document to .code_my_spec/spec/metric_flow_web/ai_live/insights.spec.md.
