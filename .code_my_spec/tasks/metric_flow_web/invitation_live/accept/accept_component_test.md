<!-- cms:task type="ComponentTest" component="MetricFlowWeb.InvitationLive.Accept" -->
...
Component Design File: .code_my_spec/spec/metric_flow_web/invitation_live/accept.spec.md
...
Write the test file to test/metric_flow_web/live/invitation_live/accept_test.exs.
