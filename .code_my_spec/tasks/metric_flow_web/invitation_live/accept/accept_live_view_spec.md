<!-- cms:task type="LiveViewSpec" component="MetricFlowWeb.InvitationLive.Accept" -->
...
Component Description: Accept invitation flow.
Type: liveview
...
Write the document to .code_my_spec/spec/metric_flow_web/invitation_live/accept.spec.md.
