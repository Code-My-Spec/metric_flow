<!-- cms:task type="LiveViewSpec" component="MetricFlowWeb.InvitationLive.Send" -->
...
Component Name: Send
Component Description: Send invitations to users/agencies.
Type: liveview
...
Write the document to .code_my_spec/spec/metric_flow_web/invitation_live/send.spec.md.
