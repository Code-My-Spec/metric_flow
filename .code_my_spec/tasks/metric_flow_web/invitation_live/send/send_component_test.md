<!-- cms:task type="ComponentTest" component="MetricFlowWeb.InvitationLive.Send" -->
...
Component Design File: .code_my_spec/spec/metric_flow_web/invitation_live/send.spec.md
...
Write the test file to test/metric_flow_web/live/invitation_live/send_test.exs.
