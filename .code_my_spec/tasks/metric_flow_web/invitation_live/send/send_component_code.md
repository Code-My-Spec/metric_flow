<!-- cms:task type="ComponentCode" component="MetricFlowWeb.InvitationLive.Send" -->
...
Component Name: Send
Component Description: Send email invitations to users or agencies to grant them access to the active account. Displays a send-invitation form and a list of pending invitations. Only owners and admins of the active account may access this page. Invitations are sent to any email address — the recipient does not need to have an existing account. Pending invitations can be cancelled by the inviting user, an owner, or an admin.
Type: liveview

Spec File: .code_my_spec/spec/metric_flow_web/invitation_live/send.spec.md
Test File: test/metric_flow_web/live/invitation_live/send_test.exs
...
Write the implementation to lib/metric_flow_web/live/invitation_live/send.ex
