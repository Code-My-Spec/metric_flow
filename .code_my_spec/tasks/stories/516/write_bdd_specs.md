# Write BDD Specs: Sync Google Search Console Data

**Story ID**: 516

A detailed prompt has been written to: `.code_my_spec/tasks/stories/516/subagent_prompts/bdd_specs_prompt.md`
