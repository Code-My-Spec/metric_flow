# Write BDD Specs: View Correlation Analysis Results (Raw Mode)

**Story ID**: 448

A detailed prompt has been written to: `.code_my_spec/tasks/stories/448/subagent_prompts/bdd_specs_prompt.md`
