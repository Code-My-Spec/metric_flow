...
**ID**: 446
**Title**: Select Goal Metrics for Correlation
**Description**: As a client user, I want to specify which metrics are my business goals so that the system can identify what drives those outcomes.
**Priority**: 31

## Component Under Test

**Module**: `MetricFlowWeb.CorrelationLive.Goals`
**Type**: liveview

## Acceptance Criteria

### Criterion 4102: User can access Goal Metrics configuration from menu

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/446_select_goal_metrics_for_correlation/criterion_4102_user_can_access_goal_metrics_configuration_from_menu_spex.exs`
...
### Criterion 4103: User can select one or more metrics as goals (e.g., revenue account from QuickBooks)

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/446_select_goal_metrics_for_correlation/criterion_4103_user_can_select_one_or_more_metrics_as_goals_eg_revenue_account_from_quickbooks_spex.exs`
...
### Criterion 4104: Selected goal metrics are highlighted or badged in metric lists

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/446_select_goal_metrics_for_correlation/criterion_4104_selected_goal_metrics_are_highlighted_or_badged_in_metric_lists_spex.exs`
...
### Criterion 4105: User can modify goal metrics at any time

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/446_select_goal_metrics_for_correlation/criterion_4105_user_can_modify_goal_metrics_at_any_time_spex.exs`
...
### Criterion 4106: System stores goal metrics per account

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/446_select_goal_metrics_for_correlation/criterion_4106_system_stores_goal_metrics_per_account_spex.exs`
...
### Criterion 4107: When user selects goal metrics, system queues correlation analysis

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/446_select_goal_metrics_for_correlation/criterion_4107_when_user_selects_goal_metrics_system_queues_correlation_analysis_spex.exs`
