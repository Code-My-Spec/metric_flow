# Write BDD Specs: Select Goal Metrics for Correlation

**Story ID**: 446

A detailed prompt has been written to: `.code_my_spec/tasks/stories/446/subagent_prompts/bdd_specs_prompt.md`
