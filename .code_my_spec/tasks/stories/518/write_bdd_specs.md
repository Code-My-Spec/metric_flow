# Write BDD Specs: Sync QuickBooks Account Transaction Data

**Story ID**: 518

A detailed prompt has been written to: `.code_my_spec/tasks/stories/518/subagent_prompts/bdd_specs_prompt.md`
