# Write BDD Specs: Flexible Chart Visualization Options

**Story ID**: 442

A detailed prompt has been written to: `.code_my_spec/tasks/stories/442/subagent_prompts/bdd_specs_prompt.md`
