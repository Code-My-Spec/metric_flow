# Write BDD Specs: View and Navigate Saved Reports

**Story ID**: 445

A detailed prompt has been written to: `.code_my_spec/tasks/stories/445/subagent_prompts/bdd_specs_prompt.md`
