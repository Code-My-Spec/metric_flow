...
**ID**: 445
**Title**: View and Navigate Saved Reports
**Description**: As a client user, I want to access my saved reports easily so that I can review important metrics regularly.
**Priority**: 28

## Component Under Test

**Module**: `MetricFlowWeb.DashboardLive.Index`
**Type**: liveview

## Acceptance Criteria

### Criterion 4095: User can view list of all saved reports

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/445_view_and_navigate_saved_reports/criterion_4095_user_can_view_list_of_all_saved_reports_spex.exs`
...
### Criterion 4096: Reports are sorted by last modified date

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/445_view_and_navigate_saved_reports/criterion_4096_reports_are_sorted_by_last_modified_date_spex.exs`
...
### Criterion 4097: User can search reports by name

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/445_view_and_navigate_saved_reports/criterion_4097_user_can_search_reports_by_name_spex.exs`
...
### Criterion 4098: Clicking report opens it in full view

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/445_view_and_navigate_saved_reports/criterion_4098_clicking_report_opens_it_in_full_view_spex.exs`
...
### Criterion 4099: Report maintains selected date range from last viewing

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/445_view_and_navigate_saved_reports/criterion_4099_report_maintains_selected_date_range_from_last_viewing_spex.exs`
...
### Criterion 4100: User can set report as favorite for quick access

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/445_view_and_navigate_saved_reports/criterion_4100_user_can_set_report_as_favorite_for_quick_access_spex.exs`
...
### Criterion 4101: User can duplicate reports to create variations

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/445_view_and_navigate_saved_reports/criterion_4101_user_can_duplicate_reports_to_create_variations_spex.exs`
