# Write BDD Specs: Create and Save Custom Reports

**Story ID**: 443

A detailed prompt has been written to: `.code_my_spec/tasks/stories/443/subagent_prompts/bdd_specs_prompt.md`
