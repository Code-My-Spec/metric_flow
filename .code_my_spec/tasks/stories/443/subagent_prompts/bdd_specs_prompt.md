...
**ID**: 443
**Title**: Create and Save Custom Reports
**Description**: As a client user, I want to create and save custom reports so that I can track specific metrics important to my business.
**Priority**: 27

## Component Under Test

**Module**: `MetricFlowWeb.DashboardLive.Editor`
**Type**: liveview

## Acceptance Criteria

### Criterion 4082: User can create new report from template or blank canvas

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/443_create_and_save_custom_reports/criterion_4082_user_can_create_new_report_from_template_or_blank_canvas_spex.exs`
...
### Criterion 4083: User can add visualizations by selecting metrics and chart types

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/443_create_and_save_custom_reports/criterion_4083_user_can_add_visualizations_by_selecting_metrics_and_chart_types_spex.exs`
...
### Criterion 4084: User can arrange visualizations in layout (drag and drop or grid)

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/443_create_and_save_custom_reports/criterion_4084_user_can_arrange_visualizations_in_layout_drag_and_drop_or_grid_spex.exs`
...
### Criterion 4085: User can name and save report

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/443_create_and_save_custom_reports/criterion_4085_user_can_name_and_save_report_spex.exs`
...
### Criterion 4086: Saved reports appear in user report list

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/443_create_and_save_custom_reports/criterion_4086_saved_reports_appear_in_user_report_list_spex.exs`
...
### Criterion 4087: User can edit saved reports

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/443_create_and_save_custom_reports/criterion_4087_user_can_edit_saved_reports_spex.exs`
...
### Criterion 4088: User can delete saved reports

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/443_create_and_save_custom_reports/criterion_4088_user_can_delete_saved_reports_spex.exs`
...
### Criterion 4089: Reports can include metrics from any connected platform (marketing and financial)

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/443_create_and_save_custom_reports/criterion_4089_reports_can_include_metrics_from_any_connected_platform_marketing_and_financial_spex.exs`
