# Write BDD Specs: Client Invites Agency or Individual User Access

**Story ID**: 428

A detailed prompt has been written to: `.code_my_spec/tasks/stories/428/subagent_prompts/bdd_specs_prompt.md`
