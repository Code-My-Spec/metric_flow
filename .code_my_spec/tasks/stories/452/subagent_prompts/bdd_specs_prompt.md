...
**ID**: 452
**Title**: LLM-Generated Custom Reports
**Description**: As a client user, I want to describe a report in natural language and have it generated automatically so that I can create custom visualizations without learning Vega-Lite syntax.
**Priority**: 27

## Component Under Test

**Module**: `MetricFlowWeb.AiLive.ReportGenerator`
**Type**: liveview

## Acceptance Criteria

### Criterion 4145: User can enter natural language description of desired report

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/452_llm-generated_custom_reports/criterion_4145_user_can_enter_natural_language_description_of_desired_report_spex.exs`
...
### Criterion 4146: LLM generates valid Vega-Lite specification

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/452_llm-generated_custom_reports/criterion_4146_llm_generates_valid_vega-lite_specification_spex.exs`
...
### Criterion 4147: User can preview generated visualization

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/452_llm-generated_custom_reports/criterion_4147_user_can_preview_generated_visualization_spex.exs`
...
### Criterion 4148: User can provide feedback to refine the visualization

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/452_llm-generated_custom_reports/criterion_4148_user_can_provide_feedback_to_refine_the_visualization_spex.exs`
...
### Criterion 4149: Generated report can be saved like any other custom report

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/452_llm-generated_custom_reports/criterion_4149_generated_report_can_be_saved_like_any_other_custom_report_spex.exs`
...
### Criterion 4150: User can edit Vega-Lite spec directly if desired (advanced mode)

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/452_llm-generated_custom_reports/criterion_4150_user_can_edit_vega-lite_spec_directly_if_desired_advanced_mode_spex.exs`
...
### Criterion 4151: System logs all LLM interactions for debugging

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/452_llm-generated_custom_reports/criterion_4151_system_logs_all_llm_interactions_for_debugging_spex.exs`
