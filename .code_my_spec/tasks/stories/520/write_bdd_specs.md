# Write BDD Specs: Fetch and Select Google Business Profile Locations Across Multiple Accounts

**Story ID**: 520

A detailed prompt has been written to: `.code_my_spec/tasks/stories/520/subagent_prompts/bdd_specs_prompt.md`
