...
**ID**: 449
**Title**: View Correlation Analysis Results (Smart/AI Mode)
**Description**: As a client user, I want to see AI-curated correlation insights so that I can quickly understand what matters most without analyzing raw data.
**Priority**: 33
...
### Criterion 4125: In Smart/AI mode: analysis shows top 5 positive and top 5 negative correlations

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/449_view_correlation_analysis_results_smartai_mode/criterion_4125_in_smartai_mode_analysis_shows_top_5_positive_and_top_5_negative_correlations_spex.exs`
...
### Criterion 4126: Only correlations above minimum threshold are shown (e.g., absolute value greater than 0.3)

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/449_view_correlation_analysis_results_smartai_mode/criterion_4126_only_correlations_above_minimum_threshold_are_shown_eg_absolute_value_greater_than_03_spex.exs`
...
### Criterion 4127: Results are presented with explanations (e.g., Google Ads spend shows strong correlation with revenue at 7-day lag)

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/449_view_correlation_analysis_results_smartai_mode/criterion_4127_results_are_presented_with_explanations_eg_google_ads_spend_shows_strong_correlation_with_revenue_at_7-day_lag_spex.exs`
...
### Criterion 4128: AI can highlight which correlations are most meaningful based on context

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/449_view_correlation_analysis_results_smartai_mode/criterion_4128_ai_can_highlight_which_correlations_are_most_meaningful_based_on_context_spex.exs`
...
### Criterion 4129: User can still access full ranked list if desired

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/449_view_correlation_analysis_results_smartai_mode/criterion_4129_user_can_still_access_full_ranked_list_if_desired_spex.exs`
...
### Criterion 4130: Mode selection (Raw vs Smart) is saved per user preference

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/449_view_correlation_analysis_results_smartai_mode/criterion_4130_mode_selection_raw_vs_smart_is_saved_per_user_preference_spex.exs`
