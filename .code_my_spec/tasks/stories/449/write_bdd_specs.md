# Write BDD Specs: View Correlation Analysis Results (Smart/AI Mode)

**Story ID**: 449

A detailed prompt has been written to: `.code_my_spec/tasks/stories/449/subagent_prompts/bdd_specs_prompt.md`
