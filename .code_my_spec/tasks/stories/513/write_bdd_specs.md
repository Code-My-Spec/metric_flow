# Write BDD Specs: Sync Google Business Profile Reviews

**Story ID**: 513

A detailed prompt has been written to: `.code_my_spec/tasks/stories/513/subagent_prompts/bdd_specs_prompt.md`
