# Write BDD Specs: Handle Expired or Invalid OAuth Credentials

**Story ID**: 440

A detailed prompt has been written to: `.code_my_spec/tasks/stories/440/subagent_prompts/bdd_specs_prompt.md`
