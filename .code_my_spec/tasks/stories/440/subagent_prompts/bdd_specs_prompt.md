...
**ID**: 440
**Title**: Handle Expired or Invalid OAuth Credentials
**Description**: As a client user, I want to be notified when my platform credentials expire so that I can reconnect and resume data syncing.
**Priority**: 20
...
### Criterion 4062: When OAuth token refresh fails, integration status changes to Needs Reconnection

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/440_handle_expired_or_invalid_oauth_credentials/criterion_4062_when_oauth_token_refresh_fails_integration_status_changes_to_needs_reconnection_spex.exs`
...
### Criterion 4063: User sees warning indicator on integration in dashboard

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/440_handle_expired_or_invalid_oauth_credentials/criterion_4063_user_sees_warning_indicator_on_integration_in_dashboard_spex.exs`
...
### Criterion 4064: User receives email notification about expired credentials

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/440_handle_expired_or_invalid_oauth_credentials/criterion_4064_user_receives_email_notification_about_expired_credentials_spex.exs`
...
### Criterion 4065: User can click Reconnect button to re-initiate OAuth flow

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/440_handle_expired_or_invalid_oauth_credentials/criterion_4065_user_can_click_reconnect_button_to_re-initiate_oauth_flow_spex.exs`
...
### Criterion 4066: After successful reconnection, sync resumes automatically

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/440_handle_expired_or_invalid_oauth_credentials/criterion_4066_after_successful_reconnection_sync_resumes_automatically_spex.exs`
...
### Criterion 4067: System does not delete historical data when credentials expire

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/440_handle_expired_or_invalid_oauth_credentials/criterion_4067_system_does_not_delete_historical_data_when_credentials_expire_spex.exs`
