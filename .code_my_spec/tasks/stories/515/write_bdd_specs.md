# Write BDD Specs: Calculate Rolling Review Metrics from Review Table

**Story ID**: 515

A detailed prompt has been written to: `.code_my_spec/tasks/stories/515/subagent_prompts/bdd_specs_prompt.md`
