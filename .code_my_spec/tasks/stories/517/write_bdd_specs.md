# Write BDD Specs: Sync Google Business Profile Performance Metrics

**Story ID**: 517

A detailed prompt has been written to: `.code_my_spec/tasks/stories/517/subagent_prompts/bdd_specs_prompt.md`
