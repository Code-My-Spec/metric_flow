...
**ID**: 432
**Title**: User or Agency Self-Revokes Access
**Description**: As a user with access to a client account, I want to revoke my own access so that I can cleanly end the relationship.
**Priority**: 25
...
### Criterion 4000: User can revoke their own access from client account settings

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/432_user_or_agency_self-revokes_access/criterion_4000_user_can_revoke_their_own_access_from_client_account_settings_spex.exs`
...
### Criterion 4001: Confirmation prompt warns that this action cannot be undone

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/432_user_or_agency_self-revokes_access/criterion_4001_confirmation_prompt_warns_that_this_action_cannot_be_undone_spex.exs`
...
### Criterion 4002: After revocation, client account is removed from user account list

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/432_user_or_agency_self-revokes_access/criterion_4002_after_revocation_client_account_is_removed_from_user_account_list_spex.exs`
...
### Criterion 4003: Client is notified via email when user revokes their own access

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/432_user_or_agency_self-revokes_access/criterion_4003_client_is_notified_via_email_when_user_revokes_their_own_access_spex.exs`
...
### Criterion 4004: User cannot re-access account without new invitation from client

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/432_user_or_agency_self-revokes_access/criterion_4004_user_cannot_re-access_account_without_new_invitation_from_client_spex.exs`
...
### Criterion 4005: Account originator cannot self-revoke and must transfer ownership first

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/432_user_or_agency_self-revokes_access/criterion_4005_account_originator_cannot_self-revoke_and_must_transfer_ownership_first_spex.exs`
