# Write BDD Specs: User or Agency Self-Revokes Access

**Story ID**: 432

A detailed prompt has been written to: `.code_my_spec/tasks/stories/432/subagent_prompts/bdd_specs_prompt.md`
