...
**ID**: 429
**Title**: Agency or User Accepts Client Invitation
**Description**: As an invited user, I want to accept a client invitation so that I can access their account and provide services.
**Priority**: 22

## Component Under Test

**Module**: `MetricFlowWeb.InvitationLive.Accept`
**Type**: liveview

## Acceptance Criteria

### Criterion 3977: User clicks invitation link and is taken to acceptance page

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/429_agency_or_user_accepts_client_invitation/criterion_3977_user_clicks_invitation_link_and_is_taken_to_acceptance_page_spex.exs`
...
### Criterion 3978: If not logged in, user is prompted to log in or register

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/429_agency_or_user_accepts_client_invitation/criterion_3978_if_not_logged_in_user_is_prompted_to_log_in_or_register_spex.exs`
...
### Criterion 3979: Upon acceptance, user account is granted specified access level to client account

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/429_agency_or_user_accepts_client_invitation/criterion_3979_upon_acceptance_user_account_is_granted_specified_access_level_to_client_account_spex.exs`
...
### Criterion 3980: User sees client account added to their account switcher or list

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/429_agency_or_user_accepts_client_invitation/criterion_3980_user_sees_client_account_added_to_their_account_switcher_or_list_spex.exs`
...
### Criterion 3981: Expired invitations show clear error message

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/429_agency_or_user_accepts_client_invitation/criterion_3981_expired_invitations_show_clear_error_message_spex.exs`
...
### Criterion 3982: Already-accepted invitations cannot be reused

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/429_agency_or_user_accepts_client_invitation/criterion_3982_already-accepted_invitations_cannot_be_reused_spex.exs`
...
### Criterion 3983: If invitee is part of an agency, entire agency team gets access based on agency team structure

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/429_agency_or_user_accepts_client_invitation/criterion_3983_if_invitee_is_part_of_an_agency_entire_agency_team_gets_access_based_on_agency_team_structure_spex.exs`
