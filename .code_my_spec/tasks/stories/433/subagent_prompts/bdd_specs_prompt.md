...
**Description**: As an account owner, I want to transfer ownership of my account to another user so that I can hand off the account when selling a client or changing primary contacts.
**Priority**: 24

## Component Under Test

**Module**: `MetricFlowWeb.AccountLive.Settings`
**Type**: liveview

## Acceptance Criteria

### Criterion 4006: Only current account owner can initiate ownership transfer

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/433_transfer_account_ownership/criterion_4006_only_current_account_owner_can_initiate_ownership_transfer_spex.exs`
...
### Criterion 4007: Owner can transfer to existing user with account access or send transfer invitation to new email

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/433_transfer_account_ownership/criterion_4007_owner_can_transfer_to_existing_user_with_account_access_or_send_transfer_invitation_to_new_email_spex.exs`
...
### Criterion 4008: Transfer requires new owner to accept via email confirmation

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/433_transfer_account_ownership/criterion_4008_transfer_requires_new_owner_to_accept_via_email_confirmation_spex.exs`
...
### Criterion 4009: Transfer wizard asks: Do you want to make a copy in your own account, Do you want to remain as admin after transfer

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/433_transfer_account_ownership/criterion_4009_transfer_wizard_asks_do_you_want_to_make_a_copy_in_your_own_account_do_you_want_to_remain_as_admin_after_transfer_spex.exs`
...
### Criterion 4010: New owner must authenticate or verify identity before accepting

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/433_transfer_account_ownership/criterion_4010_new_owner_must_authenticate_or_verify_identity_before_accepting_spex.exs`
...
### Criterion 4011: Upon acceptance, ownership transfers completely to new owner

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/433_transfer_account_ownership/criterion_4011_upon_acceptance_ownership_transfers_completely_to_new_owner_spex.exs`
...
### Criterion 4012: Previous owner access level changes based on their selection during transfer

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/433_transfer_account_ownership/criterion_4012_previous_owner_access_level_changes_based_on_their_selection_during_transfer_spex.exs`
...
### Criterion 4013: If account has originator relationship for white-label, originator status can optionally transfer too

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/433_transfer_account_ownership/criterion_4013_if_account_has_originator_relationship_for_white-label_originator_status_can_optionally_transfer_too_spex.exs`
...
### Criterion 4014: All users are notified of ownership change

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/433_transfer_account_ownership/criterion_4014_all_users_are_notified_of_ownership_change_spex.exs`
...
### Criterion 4015: System logs ownership transfer with both parties confirmation

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/433_transfer_account_ownership/criterion_4015_system_logs_ownership_transfer_with_both_parties_confirmation_spex.exs`
