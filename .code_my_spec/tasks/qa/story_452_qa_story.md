...
## Story: LLM-Generated Custom Reports
...
- Save all screenshots to `.code_my_spec/qa/452/screenshots/` — they are evidence and must be committed

## Linked Component: ReportGenerator

This story is implemented by `MetricFlowWeb.AiLive.ReportGenerator` (liveview).
Reading the source code and spec will help you understand what to test
and how the feature works.

- Spec: `.code_my_spec/spec/metric_flow_web/ai_live/report_generator.spec.md`
- Tests: `test/metric_flow_web/live/ai_live/report_generator_test.exs`
- Source: `lib/metric_flow_web/live/ai_live/report_generator.ex`
...
1. Read the brief at `.code_my_spec/qa/452/brief.md` for the complete testing plan
...
7. Capture a screenshot at each key state — save to `.code_my_spec/qa/452/screenshots/`
8. Attempt to resolve any issues with the plan or the QA scripts before finishing
9. Write the result to `.code_my_spec/qa/452/result.md` following the format below
