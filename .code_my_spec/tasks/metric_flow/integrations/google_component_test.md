...
Component Design File: .code_my_spec/spec/metric_flow/integrations/providers/google.spec.md
...
Write the test file to test/metric_flow/integrations/providers/google_test.exs.
