...
Component Design File: .code_my_spec/spec/metric_flow/integrations/quick_books_accounts.spec.md
...
Write the test file to test/metric_flow/integrations/quick_books_accounts_test.exs.
