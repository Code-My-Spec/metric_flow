...
Existing Implementation: lib/metric_flow/integrations/providers/google_ads.ex.
...
Write the document to .code_my_spec/spec/metric_flow/integrations/providers/google_ads.spec.md.
