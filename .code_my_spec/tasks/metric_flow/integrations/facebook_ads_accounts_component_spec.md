...
Existing Implementation: lib/metric_flow/integrations/facebook_ads_accounts.ex.
...
Write the document to .code_my_spec/spec/metric_flow/integrations/facebook_ads_accounts.spec.md.
