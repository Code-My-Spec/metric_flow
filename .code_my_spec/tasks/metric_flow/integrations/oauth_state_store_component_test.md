...
Component Design File: .code_my_spec/spec/metric_flow/integrations/oauth_state_store.spec.md
...
Write the test file to test/metric_flow/integrations/oauth_state_store_test.exs.
