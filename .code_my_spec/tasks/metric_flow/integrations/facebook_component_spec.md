...
Existing Implementation: lib/metric_flow/integrations/providers/facebook.ex.
...
Write the document to .code_my_spec/spec/metric_flow/integrations/providers/facebook.spec.md.
