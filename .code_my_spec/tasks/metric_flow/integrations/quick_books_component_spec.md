...
Existing Implementation: lib/metric_flow/integrations/providers/quick_books.ex.
...
Write the document to .code_my_spec/spec/metric_flow/integrations/providers/quick_books.spec.md.
