<!-- cms:task type="ComponentCode" component="MetricFlow.Integrations" -->
...
Component Description: OAuth connections to external platforms. Orchestrates OAuth flows using Assent strategies and provider implementations, persisting tokens and user metadata through the IntegrationRepository.
Type: context

Spec File: .code_my_spec/spec/metric_flow/integrations.spec.md
Test File: test/metric_flow/integrations_test.exs
...
Write the implementation to lib/metric_flow/integrations.ex
