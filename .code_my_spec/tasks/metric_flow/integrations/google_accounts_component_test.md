...
Component Name: GoogleAccounts
Component Type: module

Parent Context Design File: no parent design
Component Design File: .code_my_spec/spec/metric_flow/integrations/google_accounts.spec.md
...
Write the test file to test/metric_flow/integrations/google_accounts_test.exs.
