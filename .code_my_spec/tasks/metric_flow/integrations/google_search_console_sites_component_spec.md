...
Existing Implementation: lib/metric_flow/integrations/google_search_console_sites.ex.
...
Write the document to .code_my_spec/spec/metric_flow/integrations/google_search_console_sites.spec.md.
