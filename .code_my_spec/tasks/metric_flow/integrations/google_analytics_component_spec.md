...
Existing Implementation: lib/metric_flow/integrations/providers/google_analytics.ex.
...
Write the document to .code_my_spec/spec/metric_flow/integrations/providers/google_analytics.spec.md.
