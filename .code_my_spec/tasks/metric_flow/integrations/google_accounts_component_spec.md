...
Existing Implementation: lib/metric_flow/integrations/google_accounts.ex.
...
Write the document to .code_my_spec/spec/metric_flow/integrations/google_accounts.spec.md.
