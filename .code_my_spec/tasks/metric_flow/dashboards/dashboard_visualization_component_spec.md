<!-- cms:task type="ComponentSpec" component="MetricFlow.Dashboards.DashboardVisualization" -->
...
Component Name: DashboardVisualization
Component Description: Junction: dashboard_id, visualization_id, position, size
Type: schema

Existing Implementation: lib/metric_flow/dashboards/dashboard_visualization.ex.
Existing tests: test/metric_flow/dashboards/dashboard_visualization_test.exs
...
Write the document to .code_my_spec/spec/metric_flow/dashboards/dashboard_visualization.spec.md.
