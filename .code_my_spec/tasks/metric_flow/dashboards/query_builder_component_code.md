...
Component Description: Pure module that builds structured query params from filter inputs (date range, platforms, metric names)
Type: module

Spec File: .code_my_spec/spec/metric_flow/dashboards/query_builder.spec.md
Test File: test/metric_flow/dashboards/query_builder_test.exs
...
Write the implementation to lib/metric_flow/dashboards/query_builder.ex
