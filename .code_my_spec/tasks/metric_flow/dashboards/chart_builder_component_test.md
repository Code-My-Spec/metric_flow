...
Component Name: ChartBuilder
Component Type: module

Parent Context Design File: no parent design
Component Design File: .code_my_spec/spec/metric_flow/dashboards/chart_builder.spec.md
...
Write the test file to test/metric_flow/dashboards/chart_builder_test.exs.
