...
Component Design File: .code_my_spec/spec/metric_flow/dashboards/query_builder.spec.md
...
Write the test file to test/metric_flow/dashboards/query_builder_test.exs.
