<!-- cms:task type="ComponentTest" component="MetricFlow.Dashboards" -->
...
Component Design File: .code_my_spec/spec/metric_flow/dashboards.spec.md
...
Write the test file to test/metric_flow/dashboards_test.exs.
