<!-- cms:task type="ComponentSpec" component="MetricFlow.Dashboards.Visualization" -->
...
Component Description: Standalone Vega-Lite spec with name, owner (user_id), raw vega_spec JSON map, and a shareable flag. A single Visualization may be referenced by many dashboards via the DashboardVisualization join schema, enabling reuse across dashboard collections without duplication.
Type: schema

Existing Implementation: lib/metric_flow/dashboards/visualization.ex.
Existing tests: test/metric_flow/dashboards/visualization_test.exs
...
Write the document to .code_my_spec/spec/metric_flow/dashboards/visualization.spec.md.
