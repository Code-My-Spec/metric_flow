...
Component Description: Ecto schema representing a named dashboard collection. Stores the dashboard name, owner reference, and a boolean flag indicating whether it is a built-in (canned) dashboard. Has many visualizations through DashboardVisualization.
Type: schema

Spec File: .code_my_spec/spec/metric_flow/dashboards/dashboard.spec.md
Test File: test/metric_flow/dashboards/dashboard_test.exs
...
Write the implementation to lib/metric_flow/dashboards/dashboard.ex
