<!-- cms:task type="ComponentSpec" component="MetricFlow.Ai.ChatMessage" -->
...
Component Description: Individual message: session_id, role, content
Type: schema

Existing Implementation: lib/metric_flow/ai/chat_message.ex.
Existing tests: test/metric_flow/ai/chat_message_test.exs
...
Write the document to .code_my_spec/spec/metric_flow/ai/chat_message.spec.md.
