<!-- cms:task type="ComponentSpec" component="MetricFlow.Ai.ChatSession" -->
...
Component Description: Chat conversation: user_id, account_id, context
Type: schema

Existing Implementation: lib/metric_flow/ai/chat_session.ex.
Existing tests: test/metric_flow/ai/chat_session_test.exs
...
Write the document to .code_my_spec/spec/metric_flow/ai/chat_session.spec.md.
