<!-- cms:task type="ComponentSpec" component="MetricFlow.Ai.SuggestionFeedback" -->
...
Component Description: User feedback on suggestions
Type: schema

Existing Implementation: lib/metric_flow/ai/suggestion_feedback.ex.
Existing tests: test/metric_flow/ai/suggestion_feedback_test.exs
...
Write the document to .code_my_spec/spec/metric_flow/ai/suggestion_feedback.spec.md.
