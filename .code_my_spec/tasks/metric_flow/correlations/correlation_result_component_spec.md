<!-- cms:task type="ComponentSpec" component="MetricFlow.Correlations.CorrelationResult" -->
...
Component Description: Calculated correlation: account_id, metric_id, goal_metric_id, coefficient, optimal_lag, calculated_at
Type: schema

Existing Implementation: lib/metric_flow/correlations/correlation_result.ex.
...
Write the document to .code_my_spec/spec/metric_flow/correlations/correlation_result.spec.md.
