<!-- cms:task type="ComponentSpec" component="MetricFlow.Correlations.CorrelationJob" -->
...
Component Description: Scheduled/running correlation calculation
Type: schema

Existing Implementation: lib/metric_flow/correlations/correlation_job.ex.
...
Write the document to .code_my_spec/spec/metric_flow/correlations/correlation_job.spec.md.
