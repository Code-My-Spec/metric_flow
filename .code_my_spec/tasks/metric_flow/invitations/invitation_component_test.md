<!-- cms:task type="ComponentTest" component="MetricFlow.Invitations.Invitation" -->
...
Component Design File: .code_my_spec/spec/metric_flow/invitations/invitation.spec.md
...
Write the test file to test/metric_flow/invitations/invitation_test.exs.
