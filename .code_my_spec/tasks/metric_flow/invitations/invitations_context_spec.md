<!-- cms:task type="ContextSpec" component="MetricFlow.Invitations" -->
...
Context Name: Invitations
Context Description: Invitation flow for granting account access.
Type: context
...
Please write the specification to: .code_my_spec/spec/metric_flow/invitations.spec.md
