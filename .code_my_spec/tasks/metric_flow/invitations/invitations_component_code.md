<!-- cms:task type="ComponentCode" component="MetricFlow.Invitations" -->
...
Component Name: Invitations
Component Description: Invitation flow for granting account access.
...
Spec File: .code_my_spec/spec/metric_flow/invitations.spec.md
Test File: test/metric_flow/invitations_test.exs
...
Write the implementation to lib/metric_flow/invitations.ex
