<!-- cms:task type="ComponentSpec" component="MetricFlow.Invitations.InvitationNotifier" -->
...
Existing Implementation: lib/metric_flow/invitations/invitation_notifier.ex.
...
Write the document to .code_my_spec/spec/metric_flow/invitations/invitation_notifier.spec.md.
