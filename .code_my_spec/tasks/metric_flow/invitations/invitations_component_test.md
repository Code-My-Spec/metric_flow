<!-- cms:task type="ComponentTest" component="MetricFlow.Invitations" -->
...
Component Design File: .code_my_spec/spec/metric_flow/invitations.spec.md
...
Write the test file to test/metric_flow/invitations_test.exs.
