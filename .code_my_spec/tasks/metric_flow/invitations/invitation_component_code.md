<!-- cms:task type="ComponentCode" component="MetricFlow.Invitations.Invitation" -->
...
Component Description: Ecto schema representing an account access invitation.
...
Spec File: .code_my_spec/spec/metric_flow/invitations/invitation.spec.md
Test File: test/metric_flow/invitations/invitation_test.exs
...
Write the implementation to lib/metric_flow/invitations/invitation.ex
