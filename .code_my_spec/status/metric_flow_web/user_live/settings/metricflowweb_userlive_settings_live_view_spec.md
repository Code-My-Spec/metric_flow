<!-- cms:task type="LiveViewSpec" component="MetricFlowWeb.UserLive.Settings" -->
...
Component Description: User settings including password reset.
Type: liveview

Existing Implementation: lib/metric_flow_web/live/user_live/settings.ex
Existing tests: test/metric_flow_web/live/user_live/settings_test.exs
...
Write the document to .code_my_spec/spec/metric_flow_web/user_live/settings.spec.md.
