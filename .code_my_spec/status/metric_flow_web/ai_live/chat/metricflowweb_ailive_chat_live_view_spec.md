<!-- cms:task type="LiveViewSpec" component="MetricFlowWeb.AiLive.Chat" -->
...
Component Name: Chat
Component Description: AI chat interface for data exploration. Displays a sidebar of previous chat sessions and an active conversation area. Users can start new sessions, continue existing ones, and ask natural language questions about their metrics. Assistant responses are streamed token-by-token.
Type: liveview

Existing Implementation: lib/metric_flow_web/live/ai_live/chat.ex
Existing tests: test/metric_flow_web/live/ai_live/chat_test.exs
...
Write the document to .code_my_spec/spec/metric_flow_web/ai_live/chat.spec.md.
