<!-- cms:task type="LiveViewSpec" component="MetricFlowWeb.AgencyLive.Settings" -->
...
Component Description: Agency configuration: auto-enrollment, white-label.
Type: liveview

Existing Implementation: lib/metric_flow_web/live/agency_live/settings.ex
Existing tests: test/metric_flow_web/live/agency_live/settings_test.exs
...
Write the document to .code_my_spec/spec/metric_flow_web/agency_live/settings.spec.md.
