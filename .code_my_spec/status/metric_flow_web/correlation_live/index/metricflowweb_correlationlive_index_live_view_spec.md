<!-- cms:task type="LiveViewSpec" component="MetricFlowWeb.CorrelationLive.Index" -->
...
Component Description: View correlation analysis (Raw and Smart modes), displays automated correlation results.
Type: liveview

Existing Implementation: lib/metric_flow_web/live/correlation_live/index.ex
Existing tests: test/metric_flow_web/live/correlation_live/index_test.exs
...
Write the document to .code_my_spec/spec/metric_flow_web/correlation_live/index.spec.md.
