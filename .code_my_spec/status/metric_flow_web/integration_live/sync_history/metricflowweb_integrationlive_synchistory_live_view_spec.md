<!-- cms:task type="LiveViewSpec" component="MetricFlowWeb.IntegrationLive.SyncHistory" -->
...
Component Name: SyncHistory
Component Description: View sync status and history, shows automated daily sync results.
Type: liveview

Existing Implementation: lib/metric_flow_web/live/integration_live/sync_history.ex
Existing tests: test/metric_flow_web/live/integration_live/sync_history_test.exs
...
Write the document to .code_my_spec/spec/metric_flow_web/integration_live/sync_history.spec.md.
