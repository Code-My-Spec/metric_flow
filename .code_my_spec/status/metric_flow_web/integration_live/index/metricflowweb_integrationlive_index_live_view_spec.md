<!-- cms:task type="LiveViewSpec" component="MetricFlowWeb.IntegrationLive.Index" -->
...
Component Description: List and manage integrations, manual sync trigger.
Type: liveview

Existing Implementation: lib/metric_flow_web/live/integration_live/index.ex
Existing tests: test/metric_flow_web/live/integration_live/index_test.exs
...
Write the document to .code_my_spec/spec/metric_flow_web/integration_live/index.spec.md.
