<!-- cms:task type="QaStory" component="424" -->

# QA Story 424: Execute Tests
...
## Story: User Registration and Account Creation
...
- Save all screenshots to `.code_my_spec/qa/424/screenshots/` — they are evidence and must be committed

## Linked Component: Registration

This story is implemented by `MetricFlowWeb.UserLive.Registration` (liveview).
Reading the source code and spec will help you understand what to test
and how the feature works.

- Spec: `.code_my_spec/spec/metric_flow_web/user_live/registration.spec.md`
- Source: `lib/metric_flow_web/live/user_live/registration.ex`
- Tests: `test/metric_flow_web/live/user_live/registration_test.exs`
...
2. Read the brief at `.code_my_spec/qa/424/brief.md` for the complete testing plan
...
7. Capture a screenshot at each key state — save to `.code_my_spec/qa/424/screenshots/`
8. Attempt to resolve any issues with the plan or the QA scripts before finishing
9. Write the result to `.code_my_spec/qa/424/result.md` following the format below
