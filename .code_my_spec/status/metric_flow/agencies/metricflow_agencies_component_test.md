<!-- cms:task type="ComponentTest" component="MetricFlow.Agencies" -->
...
Component Name: Agencies
Component Type: context

Parent Context Design File: no parent design
Component Design File: .code_my_spec/spec/metric_flow/agencies.spec.md
...
Write the test file to test/metric_flow/agencies_test.exs.
