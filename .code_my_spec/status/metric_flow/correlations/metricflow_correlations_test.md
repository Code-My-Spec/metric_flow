<!-- cms:task type="ComponentTest" component="MetricFlow.Correlations" -->
...
Component Design File: .code_my_spec/spec/metric_flow/correlations.spec.md
...
Write the test file to test/metric_flow/correlations_test.exs.
