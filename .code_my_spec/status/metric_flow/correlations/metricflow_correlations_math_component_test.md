<!-- cms:task type="ComponentTest" component="MetricFlow.Correlations.Math" -->
...
Component Design File: .code_my_spec/spec/metric_flow/correlations/math.spec.md
...
Write the test file to test/metric_flow/correlations/math_test.exs.
