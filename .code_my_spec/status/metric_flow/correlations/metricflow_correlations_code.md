<!-- cms:task type="ComponentCode" component="MetricFlow.Correlations" -->
...
Component Name: Correlations
Component Description: Correlation calculations and analysis results. Computes Pearson correlation coefficients with time-lagged cross-correlation (TLCC) between marketing/financial metrics and user-selected goal metrics. Orchestrates background correlation jobs via Oban, stores results, and exposes query functions for the CorrelationLive views.
Type: context

Spec File: .code_my_spec/spec/metric_flow/correlations.spec.md
Test File: test/metric_flow/correlations_test.exs
...
Write the implementation to lib/metric_flow/correlations.ex
