<!-- cms:task type="ContextSpec" component="MetricFlow.Correlations" -->
...
Context Name: Correlations
Context Description: Correlation calculations and analysis results.
Type: context
...
Please write the specification to: .code_my_spec/spec/metric_flow/correlations.spec.md
