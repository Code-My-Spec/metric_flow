<!-- cms:task type="ComponentTest" component="MetricFlow.DataSync.SyncWorker" -->
...
Component Design File: .code_my_spec/spec/metric_flow/data_sync/sync_worker.spec.md
...
Write the test file to test/metric_flow/data_sync/sync_worker_test.exs.
