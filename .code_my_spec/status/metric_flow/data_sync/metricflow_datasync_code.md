<!-- cms:task type="ComponentCode" component="MetricFlow.DataSync" -->
...
Component Name: DataSync
Component Description: Sync scheduling, execution, and history tracking. Orchestrates automated daily syncs and manual data pulls from external platforms (Google Ads, Google Analytics, Facebook Ads, QuickBooks), persisting unified metrics through the Metrics context.
Type: context

Spec File: .code_my_spec/spec/metric_flow/data_sync.spec.md
Test File: test/metric_flow/data_sync_test.exs
...
Write the implementation to lib/metric_flow/data_sync.ex
