<!-- cms:task type="ComponentCode" component="MetricFlow.DataSync.SyncHistoryRepository" -->
...
Component Name: SyncHistoryRepository
Component Description: Data access layer for SyncHistory read operations filtered by user_id. All operations are scoped via Scope struct for multi-tenant isolation. Provides list_sync_history/2 with filter options (provider, limit, offset), get_sync_history/2, and create_sync_history/2 functions. Queries ordered by most recent first.
Type: module

Spec File: .code_my_spec/spec/metric_flow/data_sync/sync_history_repository.spec.md
Test File: test/metric_flow/data_sync/sync_history_repository_test.exs
...
Write the implementation to lib/metric_flow/data_sync/sync_history_repository.ex
