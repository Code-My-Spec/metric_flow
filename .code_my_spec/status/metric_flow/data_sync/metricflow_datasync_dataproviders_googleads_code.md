<!-- cms:task type="ComponentCode" component="MetricFlow.DataSync.DataProviders.GoogleAds" -->
...
Component Name: GoogleAds
Component Description: Google Ads provider implementation using Google Ads API v16+. Fetches campaign performance metrics including impressions, clicks, cost, conversions, ctr, cpc, and conversion_rate with dimension breakdowns by campaign_name, ad_group_name, and date. Uses GAQL (Google Ads Query Language) for data retrieval. Transforms API response to unified metric format. Handles customer account selection and date range filtering. Stores metrics with provider :google_ads.
Type: module

Spec File: .code_my_spec/spec/metric_flow/data_sync/data_providers/google_ads.spec.md
Test File: test/metric_flow/data_sync/data_providers/google_ads_test.exs
...
Write the implementation to lib/metric_flow/data_sync/data_providers/google_ads.ex
