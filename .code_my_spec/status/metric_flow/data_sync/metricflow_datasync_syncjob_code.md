<!-- cms:task type="ComponentCode" component="MetricFlow.DataSync.SyncJob" -->
...
Component Name: SyncJob
Component Description: Ecto schema representing scheduled or running sync jobs. Stores user_id, integration_id, provider, status (pending, running, completed, failed, cancelled), started_at, and completed_at timestamps. Belongs to User and Integration. Provides status transition functions and running time calculations.
Type: module

Spec File: .code_my_spec/spec/metric_flow/data_sync/sync_job.spec.md
Test File: test/metric_flow/data_sync/sync_job_test.exs
...
Write the implementation to lib/metric_flow/data_sync/sync_job.ex
