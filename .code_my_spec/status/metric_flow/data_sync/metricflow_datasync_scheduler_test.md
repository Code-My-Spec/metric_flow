<!-- cms:task type="ComponentTest" component="MetricFlow.DataSync.Scheduler" -->
...
Component Design File: .code_my_spec/spec/metric_flow/data_sync/scheduler.spec.md
...
Write the test file to test/metric_flow/data_sync/scheduler_test.exs.
