<!-- cms:task type="ComponentCode" component="MetricFlow.DataSync.SyncHistory" -->
...
Write the implementation to lib/metric_flow/data_sync/sync_history.ex
