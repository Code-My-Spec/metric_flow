<!-- cms:task type="ComponentCode" component="MetricFlow.DataSync.Scheduler" -->
...
Component Description: Oban scheduled job that runs daily to enqueue sync jobs for all active integrations. Uses cron schedule to trigger at configured time (e.g., 2am UTC). Queries all integrations across all users, filters to integrations with valid tokens, creates SyncJob records, and enqueues SyncWorker jobs.
Type: module

Spec File: .code_my_spec/spec/metric_flow/data_sync/scheduler.spec.md
Test File: test/metric_flow/data_sync/scheduler_test.exs
...
Write the implementation to lib/metric_flow/data_sync/scheduler.ex
