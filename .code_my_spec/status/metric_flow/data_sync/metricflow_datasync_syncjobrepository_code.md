<!-- cms:task type="ComponentCode" component="MetricFlow.DataSync.SyncJobRepository" -->
...
Component Name: SyncJobRepository
Component Description: Data access layer for SyncJob CRUD operations filtered by user_id. All operations are scoped via Scope struct for multi-tenant isolation. Provides list_sync_jobs/1, get_sync_job/2, create_sync_job/3, update_sync_job_status/3, and cancel_sync_job/2 functions.
Type: module

Spec File: .code_my_spec/spec/metric_flow/data_sync/sync_job_repository.spec.md
Test File: test/metric_flow/data_sync/sync_job_repository_test.exs
...
Write the implementation to lib/metric_flow/data_sync/sync_job_repository.ex
