<!-- cms:task type="ComponentTest" component="MetricFlow.DataSync.SyncJob" -->
...
Component Design File: .code_my_spec/spec/metric_flow/data_sync/sync_job.spec.md
...
Write the test file to test/metric_flow/data_sync/sync_job_test.exs.
