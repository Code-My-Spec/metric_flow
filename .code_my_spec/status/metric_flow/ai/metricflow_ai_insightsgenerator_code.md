<!-- cms:task type="ComponentCode" component="MetricFlow.Ai.InsightsGenerator" -->
...
Component Name: InsightsGenerator
Component Description: Correlation-based insights
Type: module

Spec File: .code_my_spec/spec/metric_flow/ai/insights_generator.spec.md
Test File: test/metric_flow/ai/insights_generator_test.exs
...
Write the implementation to lib/metric_flow/ai/insights_generator.ex
