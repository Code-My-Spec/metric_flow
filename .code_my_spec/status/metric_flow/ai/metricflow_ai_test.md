<!-- cms:task type="ComponentTest" component="MetricFlow.Ai" -->
...
Component Design File: .code_my_spec/spec/metric_flow/ai.spec.md
...
Write the test file to test/metric_flow/ai_test.exs.
