<!-- cms:task type="ComponentTest" component="MetricFlow.Ai.AiRepository" -->
...
Component Design File: .code_my_spec/spec/metric_flow/ai/ai_repository.spec.md
...
Write the test file to test/metric_flow/ai/ai_repository_test.exs.
