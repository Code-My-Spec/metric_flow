<!-- cms:task type="ComponentCode" component="MetricFlow.Ai.LlmClient" -->
...
Component Description: LLM API integration
Type: module

Spec File: .code_my_spec/spec/metric_flow/ai/llm_client.spec.md
Test File: test/metric_flow/ai/llm_client_test.exs
...
Write the implementation to lib/metric_flow/ai/llm_client.ex
