<!-- cms:task type="ComponentTest" component="MetricFlow.Ai.InsightsGenerator" -->
...
Component Design File: .code_my_spec/spec/metric_flow/ai/insights_generator.spec.md
...
Write the test file to test/metric_flow/ai/insights_generator_test.exs.
