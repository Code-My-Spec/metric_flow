<!-- cms:task type="ComponentCode" component="MetricFlow.Ai.ReportGenerator" -->
...
Component Description: Natural language to Vega-Lite
Type: module

Spec File: .code_my_spec/spec/metric_flow/ai/report_generator.spec.md
Test File: test/metric_flow/ai/report_generator_test.exs
...
Write the implementation to lib/metric_flow/ai/report_generator.ex
