<!-- cms:task type="ComponentTest" component="MetricFlow.Ai.ReportGenerator" -->
...
Component Design File: .code_my_spec/spec/metric_flow/ai/report_generator.spec.md
...
Write the test file to test/metric_flow/ai/report_generator_test.exs.
