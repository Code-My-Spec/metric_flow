<!-- cms:task type="ComponentTest" component="MetricFlow.Ai.ChatMessage" -->
...
Component Design File: .code_my_spec/spec/metric_flow/ai/chat_message.spec.md
...
Write the test file to test/metric_flow/ai/chat_message_test.exs.
