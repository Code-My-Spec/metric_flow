<!-- cms:task type="ContextSpec" component="MetricFlow.Ai" -->
...
Context Name: Ai
Context Description: LLM integration for chat, insights, and report generation.
Type: context
...
Please write the specification to: .code_my_spec/spec/metric_flow/ai.spec.md
