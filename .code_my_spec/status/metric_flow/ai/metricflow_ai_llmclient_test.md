<!-- cms:task type="ComponentTest" component="MetricFlow.Ai.LlmClient" -->
...
Component Design File: .code_my_spec/spec/metric_flow/ai/llm_client.spec.md
...
Write the test file to test/metric_flow/ai/llm_client_test.exs.
