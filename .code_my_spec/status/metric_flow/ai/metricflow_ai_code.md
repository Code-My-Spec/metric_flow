<!-- cms:task type="ComponentCode" component="MetricFlow.Ai" -->
...
Component Name: Ai
Component Description: LLM integration for chat, insights, and report generation. The Ai context provides AI-powered features for MetricFlow: generating actionable insights from correlation data, providing a conversational chat interface for data exploration, and generating custom Vega-Lite visualizations from natural language descriptions. Uses Anthropic Claude via the ReqLLM library. All public functions accept a `%Scope{}` as the first parameter for multi-tenant isolation.
Type: context

Spec File: .code_my_spec/spec/metric_flow/ai.spec.md
Test File: test/metric_flow/ai_test.exs
...
Write the implementation to lib/metric_flow/ai.ex
