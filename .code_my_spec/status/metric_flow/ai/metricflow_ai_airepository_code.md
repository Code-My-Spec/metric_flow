<!-- cms:task type="ComponentCode" component="MetricFlow.Ai.AiRepository" -->
...
Component Name: AiRepository
Component Description: Data access layer for all Ai context CRUD operations. All queries are scoped by account_id and/or user_id via the Scope struct for multi-tenant isolation. Provides CRUD for Insight, ChatSession, ChatMessage, and SuggestionFeedback records with filtering and ordering.
Type: module

Spec File: .code_my_spec/spec/metric_flow/ai/ai_repository.spec.md
Test File: test/metric_flow/ai/ai_repository_test.exs
...
Write the implementation to lib/metric_flow/ai/ai_repository.ex
