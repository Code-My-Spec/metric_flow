<!-- cms:task type="ComponentSpec" component="MetricFlow.Dashboards.Dashboard" -->
...
Component Description: Collection with name, owner_id, built_in (boolean for canned)
Type: schema

Existing Implementation: lib/metric_flow/dashboards/dashboard.ex.
Existing tests: test/metric_flow/dashboards/dashboard_test.exs
...
Write the document to .code_my_spec/spec/metric_flow/dashboards/dashboard.spec.md.
