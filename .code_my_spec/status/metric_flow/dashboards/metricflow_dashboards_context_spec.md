<!-- cms:task type="ContextSpec" component="MetricFlow.Dashboards" -->
...
Context Description: Visualizations and dashboard collections.
Type: context
...
Please write the specification to: .code_my_spec/spec/metric_flow/dashboards.spec.md
