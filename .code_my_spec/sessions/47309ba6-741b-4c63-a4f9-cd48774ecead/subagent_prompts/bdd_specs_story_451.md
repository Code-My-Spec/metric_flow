...
**ID**: 451
**Title**: AI Chat for Data Exploration
**Description**: As a client user, I want to chat with AI about my data so that I can ask questions and get insights in natural language.
**Priority**: 20

## Component Under Test

**Module**: `MetricFlowWeb.AiLive.Chat`
**Type**: liveview

## Acceptance Criteria

### Criterion 4138: User can open AI chat from any report or visualization

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/451_ai_chat_for_data_exploration/criterion_4138_user_can_open_ai_chat_from_any_report_or_visualization_spex.exs`
...
### Criterion 4139: Chat context includes relevant data from current view

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/451_ai_chat_for_data_exploration/criterion_4139_chat_context_includes_relevant_data_from_current_view_spex.exs`
...
### Criterion 4140: User can ask questions like Why did my revenue drop last week

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/451_ai_chat_for_data_exploration/criterion_4140_user_can_ask_questions_like_why_did_my_revenue_drop_last_week_spex.exs`
...
### Criterion 4141: AI has access to all metrics and correlation data to answer

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/451_ai_chat_for_data_exploration/criterion_4141_ai_has_access_to_all_metrics_and_correlation_data_to_answer_spex.exs`
...
### Criterion 4142: AI can suggest visualizations or reports based on questions

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/451_ai_chat_for_data_exploration/criterion_4142_ai_can_suggest_visualizations_or_reports_based_on_questions_spex.exs`
...
### Criterion 4143: Chat history is saved per user

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/451_ai_chat_for_data_exploration/criterion_4143_chat_history_is_saved_per_user_spex.exs`
...
### Criterion 4144: User can share chat insights with team members

**Status**: ❌ MISSING
**Expected File Path**: `test/spex/451_ai_chat_for_data_exploration/criterion_4144_user_can_share_chat_insights_with_team_members_spex.exs`
