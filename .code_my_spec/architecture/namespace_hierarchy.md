...
├── VisualizationLive
│   └── Editor [liveview] Create or edit an individual standalone visualization. Authenticated users can build a named Vega-Lite chart from ava...
