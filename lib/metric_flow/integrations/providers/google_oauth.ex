defmodule MetricFlow.Integrations.Providers.GoogleOauth do
  @moduledoc """
  Google OAuth OAuth provider implementation.
  ...
  @impl true
  def config do
    client_id = Application.fetch_env!(:metric_flow, :google_oauth_client_id)
    client_secret = Application.fetch_env!(:metric_flow, :google_oauth_client_secret)
