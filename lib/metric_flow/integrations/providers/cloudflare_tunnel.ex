defmodule MetricFlow.Integrations.Providers.CloudflareTunnel do
  @moduledoc """
  Cloudflare Tunnel OAuth provider implementation.

  Configure the client credentials in your runtime config:

      config :metric_flow,
        cloudflare_tunnel_client_id: System.get_env("CLOUDFLARE_TUNNEL_CLIENT_ID"),
        cloudflare_tunnel_client_secret: System.get_env("CLOUDFLARE_TUNNEL_CLIENT_SECRET")
  """
  ...
  @callback_path "/integrations/oauth/callback/cloudflare_tunnel"

  @impl true
  def config do
    client_id = Application.fetch_env!(:metric_flow, :cloudflare_tunnel_client_id)
    client_secret = Application.fetch_env!(:metric_flow, :cloudflare_tunnel_client_secret)
