defmodule MetricFlow.Integrations.Providers.Anthropic do
  @moduledoc """
  ...
  Configure the client credentials in your runtime config:
      ...
      config :metric_flow,
        anthropic_client_id: System.get_env("ANTHROPIC_CLIENT_ID"),
  ...
  @impl true
  def config do
    client_id = Application.fetch_env!(:metric_flow, :anthropic_client_id)
    client_secret = Application.fetch_env!(:metric_flow, :anthropic_client_secret)
