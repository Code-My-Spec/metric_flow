defmodule MetricFlowSpex.Criterion4147PreviewGeneratedVisualizationSpex do
  ...
  spex "User can preview generated visualization", fail_on_error_logs: false do
    scenario "chart preview section appears after generation" do
      ...
      then_ "user generates a chart and a preview section with the rendered chart is visible", context do
